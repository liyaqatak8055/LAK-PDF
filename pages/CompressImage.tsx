...
import { formatBytes, downloadFile } from '../services/pdfService';
...
export const CompressImage: React.FC = () => {
  ...
  const handleDownloadAll = async () => {
    ...
    if (results.length === 1) {
      ...
      downloadFile(img.compressedBlob, `compressed-image.${ext}`);
    } else {
      const zip = new JSZip();
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-12">
      <div className="text-center mb-10">
        <h1 className="text-4xl font-bold text-slate-900 mb-4">Compress Images</h1>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6 sticky top-24">
              {results.length > 0 ? (
                <>
                  ...
                  <Button variant="primary" size="lg" className="w-full mb-3" onClick={handleDownloadAll}>

  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12">
      <div className="text-center mb-10">
        <h1 className="text-4xl font-bold text-slate-900 mb-4">PDF to Text</h1>
      ...
      {!file ? (
        ...
        <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
           <div className="bg-white rounded-2xl shadow-lg border border-slate-200 overflow-hidden">
             ...
             {/* Content Area */}
             <div className="relative min-h-[500px] bg-slate-50">
               {status.isProcessing ? (
               ...
               <div className="p-0 h-full">
                 <textarea 
                   className="w-full h-[600px] p-8 bg-white text-slate-800 font-mono text-sm leading-relaxed focus:outline-none resize-none"
                   value={text}
                   readOnly
